...
echo  ========================================================================
echo.
echo   PURPOSE: Re-read restaurants already in Deep Dish when information is
 echo   stale, incomplete, due for review, or had a prior fetch failure.
echo.
echo   This does NOT add new restaurants.
echo   Failure cooldowns prevent the same broken/blocked sites from occupying
 echo   every batch. The batch is spread across markets before filling.
echo.
echo  ------------------------------------------------------------------------
echo.
pause
...
echo  [2/5] Leveling case files and rebuilding all derived intelligence layers...
