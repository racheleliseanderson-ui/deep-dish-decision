...
// Promote owned-site evidence into the normal 12-field case-file floor first.
run(process.execPath, ["scripts/pipeline/level-records.mjs"]);

// Recompute both work queues from the now-current corpus.
...
// Rebuild every generated layer consumed by the application.
